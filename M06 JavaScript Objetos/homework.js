...
function invocarMetodo(objeto, metodo) {
   ...
   for(var propiedades in objeto){
      if(metodo == propiedades) objeto[propiedades]();
   }
}
...
//console.log(objetoMuchosUsuarios = [usuarios = {esPremium : true}])
...
//console.log(sumarLikesDeUsuario (objetoUsuario= {posts : [post = {likes : 5}, post = {likes : 6} ]}))
...
//console.log(objetoProducto = {precio: 10, porcentajeDeDescuento: 0.2, function(){calcularPrecioDescuento * porcentajeDeDescuento}});
